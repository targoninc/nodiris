...
export class NodeEditor {
    ...
    render(editorSize, rerenderCallback) {
        ...
        const editorX = new FjsObservable(this.position.value.x + "px");
        const editorY = new FjsObservable(this.position.value.y + "px");
        this.position.onUpdate = position => {
        ...
        return FJS.create("div")
            ...
            .children(
                FJS.create("div")
                    ...
                    .children(...this.nodes.map(node => node.render(editorSize, this.position, rerenderCallback)))
                    .build(),
    ...
    renderConnections() {
        const xState = new FjsObservable(this.position.value.x + "px");
        const yState = new FjsObservable(this.position.value.y + "px");
        this.position.onUpdate = position => {
            xState.value = position.x + "px";
            yState.value = position.y + "px";
        };
