...
export class EditorNode {
    ...
    constructor(type, position = {x: 0, y: 0}, values = {}, id = null, connections = []) {
        ...
        for (const field of this.type.fields) {
            ...
            newFields.push(new InputField(field.name, field.type, field.default, field.required, field.shown, field.connections.map(connection => new EditorConnection(connection.from, connection.to))));
        }
