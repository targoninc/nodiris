...
export class EditorNode {
    ...
    render(editorSize, rerenderCallback) {
        ...
        return FJS.create("div")
            ...
            .children(
                this.renderNodeHeader(rerenderCallback),
                FJS.create("div")
                    .classes("node-fields")
                    .children(
    ...
    renderNodeHeader(rerenderCallback) {
        return FJS.create("div")
            .classes("node-header")
            .children(
                FJS.create("span")
    ...
    renderConnectionButton() {
        const highlightClass = new FjsObservable("_");

        return FJS.create("div")
            .classes("node-connection-button", highlightClass)
            .onclick(e => {
                e.stopPropagation();
                window.nodeEditor.startConnection(this.id);
                highlightClass.value = "higlighted";
                document.addEventListener("click", e => {
                    highlightClass.value = "_";
